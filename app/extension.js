...
game.import("extension", function(lib, game, ui, get, ai, _status) {
  ...
  jl_config.jlname = {
    ...
    "xiaoshan": {
      ...
      "des": "",
      "skill": {
        "【闪魄】": "▶当有角色使用或打出【闪】时，你有90%的概率可以弃置该角色1~3张牌，然后获得这张【闪】（每回合限触发1次）。如果使用者是你，则改为摸1~3张牌。",
        "【昙花】": "▶出牌阶段开始时，你有90%的概率可以弃置至多4张【闪】并摸等量的牌，然后对一名角色造成X点伤害（X为弃牌堆中【闪】的数量且至多为8）。"
      }
    },
    "zhouyi": {
      "name": "周夷",
    ...
    "zhangqiying": {
      ...
      "skill": {
        ...
        "【点化】": "▶准备阶段，你有90%的概率可以观看牌堆顶的四张牌，然后以任意顺序放回牌堆顶。",
        "【真仪】": "▶当你对其他角色造成伤害时，你有85%的概率令此伤害+1，然后随机获得其一张牌；当你受到其他角色造成的伤害时，你有85%的概率防止此伤害，然后你随机弃置伤害来源两张牌。（每个效果每回合各限触发2次）"
      }
    },
    "shenguanyu": {
      "name": "神关羽",
    ...
    "huaman": {
      ...
      "skill": {
        ...
        "【系力】": "▶其他角色于其回合内前两次造成伤害时，你有90%的概率可以和该角色各摸1~2张牌，然后此伤害+1。"
      }
    },
    "wuliuqi": {
      "name": "伍六七",
      "des": "",
      "skill": {
        "【飞剪】": "▶出牌阶段结束时，你有85%的概率可以弃置任意张装备牌（可以不弃），然后对任意名其他角色造成共计至多X+2点伤害值（X为你弃置的装备牌数），每名角色至多分配5点。",
    ...
    "xiaosha": {
      ...
      "skill": {
        ...
        "【姝丽】": "▶结束阶段，你有95%的概率从弃牌堆获得Y张基本牌（Y为你本回合造成的伤害数且范围为3~8），然后你可以将其中的牌交给任意名角色每人一张。"
      }
    },
    "shencaocao": {
      "name": "神曹操",
      ...
      "skill": {
        ...
        "【归心】": "▶结束阶段，你有95%的概率可以随机获得任意名角色每人一张手牌，然后这些角色再随机弃置一张装备区里的牌，因此失去最后一张手牌或装备区的牌的角色失去1点体力。"
      }
    },
    "caoying": {
      "name": "曹婴",
      ...
      "skill": {
        "【凌人】": "▶你使用【杀】或伤害类锦囊牌指定目标后，你有85%的概率选择其中一个目标使此牌对其伤害+1~2然后你摸1~3张牌，并且你获得”奸雄“、“行殇”直到你下回合开始。（每回合限触发2次）",
        "【伏间】": "▶准备阶段或结束阶段，你有90%的概率可以观看一名其他角色的手牌，然后你可以获得其中至多两张牌，若颜色相同，对其造成1点伤害。"
      }
    },
    "zhugeguo": {
      "name": "诸葛果",
      ...
      "skill": {
        ...
        "【羽化】": "▶结束阶段，你有95%的概率观看牌堆顶X张牌（X为你本回合使用的锦囊牌数且至少为4），然后保留其中至多三张牌。若这三张牌花色均不同，你随机对与你阵营不同的一名其他角色造成1-2点伤害。"
      }
    },
    "nianshou": {
      "name": "年兽",
    ...
    "xiaoqiao": {
      ...
      "des": "",
      "skill": {
        "【天香】": "▶当你受到伤害时，你有90%的概率可以弃置一张手牌，防止此次伤害并选择一名其他角色，令其失去1点体力，然后其获得你弃置的牌（每回合限触发两次）",
    ...
    "xizhicai": {
      ...
      "skill": {
        "【筹策】": "▶当你受到伤害后，你有90%的概率令一名角色摸两张牌，然后弃置一名角色至多两张牌。",
    ...
    "zhugeliang": {
      ...
      "skill": {
        ...
        "【看破】": "▶其他角色使用的锦囊牌对你生效前，你有80%的概率可令此锦囊对你无效，然后摸一张牌（每回合限触发两次）。"
      }
    },
    // "daqiao": {
    //   "name": "大乔",
    ...
    "jiangwei": {
      ...
      "skill": {
        ...
        "【观星】": "▶准备阶段，你有75%的概率观看牌堆顶五张牌，然后以任意顺序放回牌堆顶或牌堆底。"
      }
    },
    "guojia": {
      "name": "郭嘉",
      ...
      "skill": {
        "【遗计】": "▶当你受到1点伤害后，你有69%的概率可以摸3张牌，然后你可以将至多3张手牌交给一至三名其他角色。",
      ...
      skill: {
        ...
        jl_xiaoshan: {
          ...
          subSkill: {
            shanpo: {
              ...
              locked: true,
              usable: 1,
              prompt2: '当有角色使用或打出【闪】时，你有90%的概率可以弃置该角色1~3张牌，然后获得这张【闪】（每回合限触发1次）。如果使用者是你，则改为摸1~3张牌。',
              filter: function(event, player) {
            ...
            tanhua: {
              ...
              forced: false,
              locked: true,
              prompt2: '出牌阶段开始时，你有90%的概率可以弃置至多4张【闪】并摸等量的牌，然后对一名角色造成X点伤害（X为弃牌堆中【闪】的数量且至多为8）。',
              ...
              content: function() {
                'step 0'
                // game.playThisAudio('voice/' + event.name + '1');
                player.chooseToDiscard([1, 4], get.prompt2('jl_xiaoshan_tanhua'), function(card) {
                  return card.name === 'shan';
                }, 'h');
                'step 1'
                if (result.bool) {
        ...
        jl_zhangqiying: {
          ...
          subSkill: {
            ...
            dianhua: {
              ...
              forced: false,
              locked: true,
              prompt2: '准备阶段，你有90%的概率可以观看牌堆顶的四张牌，然后以任意顺序放回牌堆顶。',
              trigger: {
                player: "phaseZhunbeiBegin",
              },
              filter: function() {
            ...
            zhenyi1: {
              ...
              forced: false,
              locked: true,
              prompt2: '当你对其他角色造成伤害时，你有85%的概率令此伤害+1，然后随机获得其一张牌（每回合限触发2次）。',
              trigger: {
                source: "damageBegin1",
              },
            ...
            zhenyi2: {
              ...
              forced: false,
              locked: true,
              prompt2: '当你受到其他角色造成的伤害时，你有85%的概率防止此伤害，然后你随机弃置伤害来源两张牌（每回合限触发2次）。',
              trigger: {
                player: "damageBegin3",
              },
              filter: function(trigger, player) {
        ...
        jl_guansuo: {
          ...
          subSkill: {
            ...
            zhengnan: {
              name: '征南',
              prompt2: '一名角色受到伤害后，若其体力值小于等于你，你有95%的概率摸1~3张牌，然后在“武圣”、“当先”、“制蛮”里选择并获得一个技能直到你的回合结束（每回合每名角色限触发一次），若未获得技能则你回复1点体力。',
              trigger: {
        ...
        jl_wuliuqi: {
          ...
          subSkill: {
            feijian: {
              ...
              locked: true,
              prompt2: '出牌阶段结束时，你有85%的概率可以弃置任意张装备牌（可以不弃），然后对任意名其他角色造成共计至多X+2点伤害值（X为你弃置的装备牌数），每名角色至多分配5点。',
              filter: function() {
                return Math.random() < 0.85;
              },
              check: function() {
        ...
        jl_xiaosha: {
          ...
          subSkill: {
            ...
            shuli: {
              ...
              forced: false,
              locked: true,
              prompt2: '结束阶段，你有95%的概率从弃牌堆获得Y张基本牌（Y为你本回合造成的伤害数且范围为3~8），然后你可以将其中的牌交给任意名角色每人一张。',
              trigger: {
                player: "phaseJieshuBegin",
              },
              filter: function() {
  ...
  for (const jlnameKey in jl_config.jlname) {
    ...
    for (const skillName in jl_config.jlname[jlnameKey].skill) {
      out_package.skill.translate[`jl_${jlnameKey}_info`] += `<span style="color:#9933ff"><abbr title="${skillName}：${jl_config.jlname[jlnameKey].skill[skillName]}"><ins>${skillName}</ins></abbr></span>\n`;
    }
  }
