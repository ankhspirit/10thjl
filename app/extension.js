...
game.import("extension",function(lib,game,ui,get,ai,_status){
  const playThisAudio = function(filePathInAudioDir, audioType, playAudioCallback) {
  ...
  jl_config.gameOver = function(){
    ...
    let src1=jl_config['layoutPath']+'image/img/'+'hljh.png';let src2=jl_config['layoutPath']+'image/img/'+'zhuansheng1.png';let src3=jl_config['layoutPath']+'image/img/'+'zhuansheng2.png';let src4=jl_config['layoutPath']+'image/img/'+'lingzhu.png';
  ...
  class jl {
    constructor() {
      ...
      this.close.addEventListener('click', () => {playThisAudio('click');this.closeDialog()});
  ...
  class hl {
    constructor() {
      ...
      this.hl_close.addEventListener('click', () => {playThisAudio('click');this.closeDialog()});
  ...
  class jlshop {
    constructor() {
      ...
      this.shop_close.addEventListener('click', () => {playThisAudio('click');this.closeDialog()});
      ...
      skill:{
        skill:{
            ...
            subSkill:{
              ...
              dianhua:{
                ...
                content:function(){
                  ...
                  // playThisAudio('jlVoice/'+event.name+'1');
                  // if(player==game.me){
                  // 	jl_config.settexiao();
                  // };
                  var num=4;
            ...
            subSkill:{
              ...
              qinyin:{
                ...
                content:function(){
                  ...
                  if(result.bool){
                    result.targets.sortBySeat();
                    playThisAudio('jlVoice/'+event.name+[1,2,3].randomGet());
                    if(player==game.me){
                      jl_config.settexiao();
                    };
          ...
          jl_shenzhaoyun:{
            ...
            subSkill:{
              ...
              longhun1:{
                ...
                trigger:{player:'useCard'},
                content:function(){
                  playThisAudio('jlVoice/jl_shenzhaoyun_longhun1');
                  if(player==game.me){
                    jl_config.settexiao();
                  };
            ...
            subSkill:{
              guancanghai:{
                ...
                content:function(){
                  ...
                  "step 1"
                  if(result.bool){
                    playThisAudio('jlVoice/'+event.name+[1].randomGet());
                    if(player==game.me){
                      jl_config.settexiao();
                    };
            ...
            subSkill:{
              ...
              zhanshen:{
                ...
                content:function(){
                  ...
                  if(result.bool){
                    playThisAudio('jlVoice/'+event.name+[1,2].randomGet());
                    for(var i=0;i<result.targets.length;i++)
          ...
          jl_guanyinping:{
            ...
            content:function(){
              playThisAudio('jlVoice/jl_guanyinping_xuehen1');
              trigger.num++;
              player.draw();
              if(player==game.me){
                jl_config.settexiao();
          ...
          jl_sundeng:{
            ...
            content:function(){
              'step 0'
              playThisAudio('jlVoice/jl_sundeng_kuangbi1');
          ...
          jl_caorui:{
            ...
            direct:true,
            content:function(){
              playThisAudio('jlVoice/jl_caorui_huituo1');
              player.draw();
              player.recover();
              if(player==game.me){
                jl_config.settexiao();
          ...
          jl_guohuanghou:{
            ...
            content:function(){
              ...
              if(card){
                playThisAudio('jlVoice/jl_guohuanggou_jiaozhao1');
                if(player==game.me){
                  jl_config.settexiao();
                };
          ...
          jl_yuanshao:{
            ...
            content:function(){
              ...
              playThisAudio('jlVoice/jl_yuanshao_xueyi1');
              if(player==game.me){
                jl_config.settexiao();
              };
            },
          ...
          jl_huaxiong:{
            ...
            content:function(){
              ...
              playThisAudio('jlVoice/jl_huaxiong_yaowu1');
            }
          },
          jl_xunyou:{
            charlotte:true,
            ...
            content:function(){
              "step 0"
              player.draw();
              playThisAudio('jlVoice/jl_xunyou_zhiyu1');
              if(player==game.me){
                jl_config.settexiao();
              };
              "step 1"
          ...
          jl_zhangyi:{
            ...
            // forced:true,
            content:function(){
              playThisAudio('jlVoice/jl_zhangyi_shizhi1');
              if(player==game.me){
                jl_config.settexiao();
              };
          ...
          jl_sunluban:{
            ...
            direct:true,
            content:function(){
              playThisAudio('jlVoice/jl_sunluban_jiaoyin1');
              if(player==game.me){
                jl_config.settexiao();
              };
              trigger.num--;
          ...
          jl_guohuai:{
            ...
            content:function(player){
              ...
              playThisAudio('jlVoice/jl_guohuai_jingce1');
              player.draw(2);
            },
          },
        },
