game.import("extension",function(lib,game,ui,get,ai,_status){
	...
	s_character=['shenzhouyu','shenzhaoyun','shencaocao','zhugeguo','nianshou','caoying','lingju','xiaosha','huaman','wuliuqi','shenguanyu','guansuo'];
	a_character=['diaochan','luxun','guojia','xiaoqiao','jiangwei','lvbu','zhugeliang','zhurong','zhoufei','xizhicai','sunshangxiang','menghuo','zhangxingcai','zhangfei'];
	b_character=['guanyinping','sundeng','caorui','guohuanghou','yuanshao','huaxiong','xunyou'];
	...
	{
		game.saveConfig('jl_zsd',5);game.saveConfig('jl_gjzsd',5);game.saveConfig('jl_hljh',5);game.saveConfig('jl_value',jl_valueres);game.saveConfig('jl_gmczjl',0);game.saveConfig('jl_cheat',0);
    }

	if(lib.config.jl_bugnum!=0){
		game.saveConfig('jl_zsd',15);game.saveConfig('jl_gjzsd',10);game.saveConfig('jl_hljh',15);game.saveConfig('jl_value',jl_valueres);game.saveConfig('jl_gmczjl',0);
		game.saveConfig('jl_bugnum',0);game.saveConfig('jl_gmlv','0');lib.config.jl_value[s_character[4]]['gain']=true;
	...
	if(!lib.config.jl_value["zhangfei"])
	{
		...
		game.saveConfig('jl_value',lib.config.jl_value);game.saveConfig('jl_lingzhu',0)
    }
	...
	jl_config.damageAnimation=function(name,trigger,event){
		...
		var src=jl_config['layoutPath']+'action/'+name+'3.gif';
		img.height=d;
		img.width=0.75*d;
	...
	jl_config.setchuzhan=function(name){
			...
			img.id='jl_gif';
			let src=jl_config['layoutPath']+'action/'+lib.config.jl_gmczjl+'1.gif';
			img.src=src;
	...
	jl_config.settexiao=function(){
		if(lib.config.jl_juneichangzhu==1&lib.config.jl_gmczjl!=0&lib.config.jl_gmczjl!='shenlvbu'){
			...
			if(lib.config.jl_value[lib.config.jl_gmczjl]['quality']=='s') {
				let src=jl_config['layoutPath']+'img/skill1.gif';
				img.src=src;
			}else{
				let src=jl_config['layoutPath']+'img/skill2.gif'
				img.src=src;
			}
	...
	jl_config.gameOver = function(){
		...
		if(lingzhu>0.99) a4=1
		else a4=0;
		var b1=parseInt(lib.config.jl_hljh);var b2 = parseInt(lib.config.jl_zsd);var b3 = parseInt(lib.config.jl_gjzsd);var b4 = parseInt(lib.config.jl_lingzhu);
		c1=a1+b1;c2=a2+b2;c3=a3+b3;c4=a4+b4;
		game.saveConfig('jl_hljh',c1);game.saveConfig('jl_zsd',c2);game.saveConfig('jl_gjzsd',c3);game.saveConfig('jl_lingzhu',c4);

		let img_jl_jl1=document.createElement("img");let img_jl_jl2=document.createElement("img");let img_jl_jl3=document.createElement("img");let img_jl_jl4=document.createElement("img");
		let src1=jl_config['layoutPath']+'img/'+'hljh.png';let src2=jl_config['layoutPath']+'img/'+'zhuansheng1.png';let src3=jl_config['layoutPath']+'img/'+'zhuansheng2.png';let src4=jl_config['layoutPath']+'img/'+'lingzhu.png';
		img_jl_jl1.src=src1;img_jl_jl2.src=src2;img_jl_jl3.src=src3;img_jl_jl4.src=src4
		...
		let jl_jl1= document.createElement('div');let jl_jl2= document.createElement('div');let jl_jl3= document.createElement('div');let jl_jl4= document.createElement('div');
		jl_jl1.appendChild(img_jl_jl1);jl_jl2.appendChild(img_jl_jl2);jl_jl3.appendChild(img_jl_jl3);jl_jl4.appendChild(img_jl_jl4);
		...
		let jl_jl1_text = document.createElement('div');let jl_jl2_text = document.createElement('div');let jl_jl3_text = document.createElement('div');let jl_jl4_text = document.createElement('div');
		jl_jl1.appendChild(jl_jl1_text);jl_jl2.appendChild(jl_jl2_text);jl_jl3.appendChild(jl_jl3_text);jl_jl4.appendChild(jl_jl4_text);
	...
	class jl {
		constructor() {
			...
			ui.backgroundMusic.src=jl_config['layoutPath']+'bgm/linanchuyu.mp3';
			this.jl_character=[];
				...
				if(lib.config.jl_value[i]){
					if(lib.config.jl_value[i]['quality']=='s'){
						...
						if(lib.config.jl_value[i]['gain']) {
							jl.style.backgroundImage='url('+jl_config['layoutPath']+'char/'+i+'.png'+')'
						}else jl.style.backgroundImage='url('+jl_config['layoutPath']+'silhouette/'+i+'.png'+')';
						jl.dataset.jlname=i;
					};
				}
			}
			...
			for(let i of this.jl_character){
				i.addEventListener('click',()=>{
					...
					document.getElementById("pattern").style.backgroundImage='url('+jl_config['layoutPath']+'action/'+name+'2.gif'+')';
					this.detail.show();
			...
			this.shadow1.hide();
			this.shadow2.hide();this.shadow3.hide();
			...
			this.queding1.addEventListener('click', () => {
				...
				this.tips.hide();
				this.shadow1.style.backgroundImage='url('+jl_config['layoutPath']+'action/'+beizhan+'1.gif'+')';
				this.shadow1.show();		
				setTimeout(function(){
					gamejl('zhuansheng');
					this.shadow1.style.backgroundImage='url('+jl_config['layoutPath']+'action/'+name+'1.gif'+')';
					this.shadow2.style.backgroundImage='url('+jl_config['layoutPath']+'img/zhuansheng1.gif'+')';
					this.shadow3.style.backgroundImage='url('+jl_config['layoutPath']+'img/reward1.png'+')';
					this.shadow2.show();
					this.shadow3.show();
				},500);
				setTimeout(function(){
					this.shadow3.style.backgroundImage='url('+jl_config['layoutPath']+'img/reward2.png'+')';
				},700);
				setTimeout(function(){
					this.shadow2.hide();
				},1000);
			...
			this.queding2.addEventListener('click', () => {
				...
				if(lib.config.jl_value[beizhan]['quality']=='a'){
					var name=a_character[Math.floor((Math.random()*a_character.length))];
					lib.config.jl_value[name]['gain']=true;
					game.saveConfig('jl_value',lib.config.jl_value);
					game.saveConfig('jl_gmczjl',name);
			...
			this.qlin.addEventListener('click', () => {
				document.getElementById("pmj").style.backgroundImage='url('+jl_config['layoutPath']+'img/qlin.jpg'+')';
				this.kaichangbai.hide();
				this.rukou.show();
				var a=lib.config.jl_gmczjl;
				gamejl('qlin');
				if(a!='shenlvbu'){game.saveConfig('jl_gmlv','5');
			...
			this.ql.addEventListener('click', () => {
				document.getElementById("pmj").style.backgroundImage='url('+jl_config['layoutPath']+'img/ql.jpg'+')';
				this.kaichangbai.hide();
				this.rukou.hide();
				var a=lib.config.jl_gmczjl;
				gamejl('ql');
				if(a!='shenlvbu'){game.saveConfig('jl_gmlv','4');
			...
			this.bh.addEventListener('click', () => {
				document.getElementById("pmj").style.backgroundImage='url('+jl_config['layoutPath']+'img/bh.jpg'+')';
				this.kaichangbai.hide();
				this.rukou.hide();
				var a=lib.config.jl_gmczjl;
				gamejl('bh');
				if(a!='shenlvbu'){game.saveConfig('jl_gmlv','3');
			...
			this.zq.addEventListener('click', () => {
				document.getElementById("pmj").style.backgroundImage='url('+jl_config['layoutPath']+'img/zq.jpg'+')';
				this.kaichangbai.hide();
				this.rukou.hide();
				var a=lib.config.jl_gmczjl;
				gamejl('zq');
				if(a!='shenlvbu'){game.saveConfig('jl_gmlv','2');
			...
			this.xw.addEventListener('click', () => {
				document.getElementById("pmj").style.backgroundImage='url('+jl_config['layoutPath']+'img/xw.jpg'+')';
				this.rukou.hide();
				this.kaichangbai.hide();
				var a=lib.config.jl_gmczjl;
				gamejl('xw');
				if(a!='shenlvbu'){game.saveConfig('jl_gmlv','1');
			...
			this.zhong.addEventListener('click', () => {
				document.getElementById("pmj2").style.backgroundImage='url('+jl_config['layoutPath']+'img/wszl.jpg)';
				this.kaichangbai2.hide();
				this.kuaipao.hide();
				this.zhong.hide();
				game.saveConfig('jl_gmlv','0');
				game.saveConfig('jl_gmczjl','shenlvbu');
				ui.backgroundMusic.src=jl_config['layoutPath']+'bgm/lingshan.mp3';
			});
			...
			this.close.addEventListener('click', () => {gamejl('click');this.closeDialog()});
		...
		constructor() {
			...
			this.hl_button1.addEventListener('click', () => {
				...
				if(parseInt(lib.config.jl_hljh)>0){
					...
					this.daoju.style.backgroundImage = 'url('+jl_config['layoutPath']+'sp/'+'sp_'+name+'.png'+')';
			...
			this.lantern2.addEventListener('dblclick', () => {
				...
				game.saveConfig('jl_zsd',parseInt(lib.config.jl_zsd + 50));game.saveConfig('jl_gjzsd',parseInt(lib.config.jl_gjzsd + 50));game.saveConfig('jl_hljh',parseInt(lib.config.jl_hljh + 50));
			...
			this.jl_recover.addEventListener('click', () => {
				if(lib.config.jl_cheat!=0){
					...
					this.tishis.addEventListener('dblclick', () => {
						...
						game.saveConfig('jl_zsd',5);game.saveConfig('jl_gjzsd',5);game.saveConfig('jl_hljh',5);game.saveConfig('jl_gmczjl',0);
			...
			this.hl_close.addEventListener('click', () => {gamejl('click');this.closeDialog()});
	...
	class jlshop {
		constructor() {	
			...
			this.shadow1ss.hide();this.shadow2ss.hide();this.shadow3ss.hide();
			var numberid=[];
			...
			for (var i = 0; i < commodity.length; i++) {
				...
				soul.style.backgroundImage='url('+jl_config['layoutPath']+'sp/'+'sp_'+commodity[i]+'.png'+')';
				...
				i.addEventListener('click',()=>{
					...
					if(!ccommodity.contains(i.dataset.buyname)){
						if(lib.config.jl_value[i.dataset.buyname]['sp']>19) {
							...
							gamejl('zhuansheng');
							this.shadowss.show();
							this.shadow2ss.style.backgroundImage='url('+jl_config['layoutPath']+'img/zhuansheng1.gif'+')';
							this.shadow3ss.style.backgroundImage='url('+jl_config['layoutPath']+'img/reward1.png'+')';							
							this.shadow2ss.show();
							this.shadow3ss.show();
							setTimeout(() => {
								this.shadow3ss.style.backgroundImage='url('+jl_config['layoutPath']+'img/reward2.png'+')';
							}, 300);
							setTimeout(() => {
								this.shadow1ss.style.backgroundImage='url('+jl_config['layoutPath']+'action/'+i.dataset.buyname+'2.gif'+')';
								
								this.shadow1ss.show();
								this.shadow2ss.hide();
								this.shadowss.addEventListener('click', () => {this.shadowss.hide()});
							}, 500);
							...
							this.duihuan.addEventListener('click', () => {this.duihuan.remove()});
						}
						else{
			...
			this.shop_close.addEventListener('click', () => {gamejl('click');this.closeDialog()});
		...
		gamejl = function (fn, dir, sex) {
			if (lib.config.background_speak) {
				if (dir && sex)
					...
					game.playAudio('..', 'extension', '将灵重置版','audio', fn);
			}
		}
			...
			content:function (){
        		...
        		if(lib.config.jl_juneichangzhu==1&&lib.config.jl_gmczjl!='shenlvbu'){
					if(lib.config.jl_gmczjl===undefined)
						...
						jl_config.setchuzhan();jl_config.settexiao();
					};
				}
			}
	...
	package:{
		...
		skill:{
			skill:{
				...
				jl_zhangxingcai:{
					...
					subSkill:{
						...
						qiangwu:{
							...
							filter:function(event,player){
								var numa=Math.random();return numa<0.95;
							},
							content:function(){
								"step 0"
								gamejl(event.name+'1');
				...
				jl_zhangfei:{
					...
					subSkill:{
						...
						paoxiao:{
							...
							trigger:{player:"phaseUseBegin"},
							filter:function(event,player){
								var numa=Math.random();return numa<0.85;
							},
							content:function(){
								"step 0"
								gamejl(event.name+'1');
				...
				jl_shenguanyu:{
					...
					subSkill:{
						wushen1:{
							...
							content:function(player,event){
								...
								if(result.targets){
									...
									for(var i=0;i<result.targets.length;i++){player.useCard({name:'sha',isCard:true},result.targets[i],false)}
								};
								event.finish();	
							},
							ai:{
						...
						wushen2:{
							...
							filter:function(event){return event.getParent().getParent().getParent().name=='jl_shenguanyu_wushen1';},
			        ...
			        subSkill:{
				        ...
				        qinyin:{
					        ...
					        content:function(){
						        ...
						        if(result.bool){
							       result.targets.sortBySeat();
								   gamejl(event.name+[1,2,3].randomGet());
								   if(player==game.me){
									jl_config.settexiao();	
								};
						        ...
						        'step 4'
								if (result.control=='回复体力') {player.line(targets[event.num],'green');targets[event.num].recover();event.num++};
						        if (result.control=='失去体力') {player.line(targets[event.num],'fire');targets[event.num].loseHp();event.num++};	        
						        if (result.control=='cancel2') {event.num++;event.goto(3);};
						        'step 5'
						        event.goto(3);
					        },
				        },
		        ...
		        jl_shenzhaoyun:{
			        ...
			        subSkill:{
				        ...
				        longhun1:{
					        ...
					        trigger:{player:'useCard'},
					        content:function(){
								gamejl('jl_shenzhaoyun_longhun1');
								if(player==game.me){
									jl_config.settexiao();	
								};
					...
					subSkill:{
						...
						liyu:{
							...
							content:function(){
								...
								player.gainPlayerCard(get.prompt('jl_lvbu_liyu',trigger.player),trigger.player,'hej','visibleMove').
				...
				subSkill:{
					...
					clear:{
						...
						content:function(){
							'step 0'
							target=player.storage.jl_xizhicai_xianfu[0];
				...
				jl_caoying:{
					...
					subSkill:{
							...
							content:function (event,player){
						        ...
						        if(result.bool){
						            ...
						            player.logSkill('jl_caoying_lingren',event.target)
										event.target.addTempSkill("jl_caoyingewss",{player:"damageAfter",global:"useCardAfter"});
									}else{
						...
						fujian:{
							...
							check:function(event,player){
								num1=game.countPlayer(function(current){
					...
					subSkill:{
						...
						zhanshen:{
							...
							content:function(){
								...
								if(result.bool){
									gamejl(event.name+[1,2].randomGet());
									for(var i=0;i<result.targets.length;i++)
						...
						shennu:{
							...
							direct:true,
					        preHidden:true,
							check:function(player){return true;},
							content:function(){
								"step 0"
				...
				jl_zhugeliang:{
					...
					subSkill:{
						huoji:{
							...
							frequent:true,
							filter:function(){return Math.random()<=0.85},
							content:function(){
								'step 0'
								player.draw();
								gamejl(event.name+'1');
				...
				jl_guohuanghou:{
					...
					content:function(){
						...
						if(card){
							gamejl('jl_guohuanggou_jiaozhao1');
							if(player==game.me){
								jl_config.settexiao();	
							};
				...
				jl_yuanshao:{
					...
					frequent:true,
					filter:function(){return Math.random()<=0.68},
					content:function(){
						player.addTempSkill(event.name+'_x');
						gamejl('jl_yuanshao_xueyi1');
						if(player==game.me){
							jl_config.settexiao();	
						};
					},
			...
			translate:{
				...
				"jl_shencaocao":"神曹操",
				"jl_xiaotao":'小桃',
				"jl_sunshangxiang":'孙尚香',"jl_zhugeliang":'诸葛亮',
				'jl_guanyinping':'关银屏',
				'jl_sundeng':'孙登','jl_caorui':'曹叡','jl_guohuanghou':'郭皇后','jl_yuanshao':'袁绍','jl_huaxiong':'华雄',
				'jl_xunyou':'荀攸',
				'jl_zhangyi':'张嶷','jl_sunluban':'孙鲁班','jl_guohuai':'郭淮',

				"jl_zhangxingcai_info": '将灵张飞，拥有技能【<span style="color:#9933ff"><abbr title="咆哮：▶你的出牌阶段开始时，有85%的概率多出1~5张【杀】，且无距离限制。"><ins>咆哮</ins></abbr></span>】、【<span style="color:#9933ff"><abbr title="替身：▶你受到伤害时，你有70%的概率回复1点体力并摸三张牌（每轮限3次）。"><ins>替身</ins></abbr></span>】',
